package com.ijiaban.navigationdrawer;
 ...
 * </p>
 */
public class SherlockActionBarDrawerToggle implements
	...
	private static class ActionBarDrawerToggleImplCompat implements
			ActionBarDrawerToggleImpl {
		@Override
		public Drawable getThemeUpIndicator(Activity activity) {
			return SherlockActionBarDrawerToggleCompat
					.getThemeUpIndicator(activity);
		}

		@Override
		public Object setActionBarUpIndicator(Object info, Activity activity,
				Drawable themeImage, int contentDescRes) {
			return SherlockActionBarDrawerToggleCompat.setActionBarUpIndicator(
					info, activity, themeImage, contentDescRes);
		}

		@Override
		public Object setActionBarDescription(Object info, Activity activity,
				int contentDescRes) {
			return SherlockActionBarDrawerToggleCompat.setActionBarDescription(
					info, activity, contentDescRes);
		}
	}

	private static class ActionBarDrawerToggleImplHC implements
			ActionBarDrawerToggleImpl {
		@Override
		public Drawable getThemeUpIndicator(Activity activity) {
			return SherlockActionBarDrawerToggleHoneycomb
					.getThemeUpIndicator(activity);
		}
		...
		public Object setActionBarUpIndicator(Object info, Activity activity,
				Drawable themeImage, int contentDescRes) {
			return SherlockActionBarDrawerToggleHoneycomb
					.setActionBarUpIndicator(info, activity, themeImage,
							contentDescRes);
		}
		...
		public Object setActionBarDescription(Object info, Activity activity,
				int contentDescRes) {
			return SherlockActionBarDrawerToggleHoneycomb
					.setActionBarDescription(info, activity, contentDescRes);
		}
	}
	 ...
	 *            accessibility
	 */
	public SherlockActionBarDrawerToggle(Activity activity,

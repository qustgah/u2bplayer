...
import com.ijiaban.fragment.ChannelWithSearchFragment.ViewHolder;
...
public class VideosByChannelFragment extends SherlockListFragment implements	LoaderCallbacks<PageBean>,
OnQueryTextListener{ 
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		playlistid = getActivity().getIntent().getStringExtra("playlistid");
		_query = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet"+"&playlistId="+playlistid+"&key="+ DeveloperKey.DEVELOPER_KEY;
		// set empty adapter
		...
		clickmore.setOnClickListener(new OnClickListener() { 
			...
			public void onClick(View v) {
				...
				_query =  "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet"+"&playlistId="+playlistid+"&pageToken="+pageBean.getNextPageToken()+"&key="+ DeveloperKey.DEVELOPER_KEY; 
				getLoaderManager().restartLoader(loaderId, null, VideosByChannelFragment.this); 
			}
		});
...
@Override
	...
	public void onLoadFinished(Loader<PageBean> loader,PageBean data) {
		...
		pageBean=data;
		List<SearchResultsItem> list = new ArrayList<SearchResultsItem>();
		try {

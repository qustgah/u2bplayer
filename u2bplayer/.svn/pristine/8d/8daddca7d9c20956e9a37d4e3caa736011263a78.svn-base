...
public class SearchListFragment extends ListFragment implements	LoaderCallbacks<PageBean>,
		OnQueryTextListener{
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		clickmore.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				_query =  Constants.URL_SEARCHLIST+"&q=" + _curFilter +"&pageToken="+pageBean.getNextPageToken()+"&key="+ DeveloperKey.DEVELOPER_KEY; 
				getLoaderManager().restartLoader(loaderId, null, SearchListFragment.this); 
			}
		});
